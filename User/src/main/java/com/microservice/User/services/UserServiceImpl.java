...
public class UserServiceImpl implements UserService {
    ...
    public List<Car> getCars(Integer userId) {
        return this.restTemplate.getForObject("http://car-service/cars/byUser/" + userId, List.class);
    }

    @Override
    public List<Bike> getBikes(Integer userId) {
        return this.restTemplate.getForObject("http://bike-service/bikes/byUser/" + userId, List.class);
    }
